                            ...
                            getUser().sendEmailVerification()
                                    .addOnCompleteListener(new OnCompleteListener<Void>() {
                                        ...
                                        public void onComplete(@NonNull Task<Void> task) {
                                            if(task.isSuccessful()) {
                                                Toast.makeText(LoginActivity.this, "valid email", Toast.LENGTH_LONG).show();
                                                startSelectActivity();
                                            }
                                            else Toast.makeText(LoginActivity.this, "invalid email", Toast.LENGTH_LONG).show();
                                        }
                                    });
                        }else{
                            Toast.makeText(LoginActivity.this, "계정생성 실패", Toast.LENGTH_LONG).show();
                        }
                        stopPD();
                    }
                });
